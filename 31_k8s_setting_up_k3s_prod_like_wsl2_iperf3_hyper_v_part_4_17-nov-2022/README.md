...
- We use the following network topology
  ...
  ![Schema1](../29_k8s_setting_up_k3s_prod_like_configuring_opnsense_creating_k3s_nodes_part_2_10-nov-2022/schema/Schema1.png)

- Firewall rules for network traffic
  
  ![firewall_rules](../29_k8s_setting_up_k3s_prod_like_configuring_opnsense_creating_k3s_nodes_part_2_10-nov-2022/images/firewall_rules.png)
